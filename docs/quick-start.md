...
On the first dictation, the app downloads the `small` Whisper model (~486 MB). This happens once and may take a minute depending on your connection. The overlay shows "Loading model..." during download.
